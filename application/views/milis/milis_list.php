            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA MILIS</h3>
                    </div>
    ...
    <div class="form-group">
      ...
      <div class="modal-footer">
                ...
                var t = $("#mytable").dataTable({
                    initComplete: function() {
                        ...
                        $("#form-create_main").on('submit',(function(e) {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('Milis/create_action') ?>",
                                type: "POST",
                        ...
                        $("#form-update_main").on('submit',(function(e) {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('Milis/update_action') ?>",
                                type: "POST",
                                data: new FormData(this),
                                contentType: false,
                                cache: false,
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?php echo base_url("milis/json") ?>', "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
        ...
        function editModal(id){
          $.get("<?php echo base_url('Milis/read') ?>/"+id, function( data ) {
          ...
          swal({
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                $.ajax({
                      url: "<?php echo base_url('Milis/delete_action') ?>/"+id,
                      type: "POST",
                      data: [],
                      contentType: false,
                      cache: false,
