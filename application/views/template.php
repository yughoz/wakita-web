...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/az-core/az-core.css">
        <!-- <link rel="stylesheet" href="<?php echo base_url() ?>assets/az-core/az-theme.css"> -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>adminlte/index2.html" class="logo">
                    ...
                    <span class="logo-lg">WAKITA</span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <?php echo anchor('ManageMenu/changePassword', 'Profile', array('class' => 'btn btn-default btn-flat')); ?>
        ...
        <script>
            $(function () {
                ...
                $(".format-number").on('keyup keydown', function(e){
        ...
        function normalAllNumber(){
            $( ".format-number" ).each(function() {
              $(this).val(remove_separator($(this).val()));
            });
        }
