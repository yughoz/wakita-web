            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">KELOLA DATA MILIS_MEMBER</h3>
                    </div>
        
        <div class="box-body">
        <div style="padding-bottom: 10px;">
        
        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#addMemberModal">Tambah Data</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">INPUT DATA  MILIS_MEMBER</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?php echo base_url("milis_member/json/").$member ?>', "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
        ...
        var tUserr = $("#tableUser").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?php echo base_url("milis_member/user/").$member ?>', "type": "POST"},
                    columns: [
                        {
                            "data": "id_users",
                            "orderable": false
        ...
        function selectingFunc(id){
          $.get("<?php echo base_url('Milis_member/add_member/').$member ?>/"+id, function( data ) {
          ...
          swal({
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                $.ajax({
                      url: "<?php echo base_url('Milis_member/delete_action') ?>/"+id,
                      type: "POST",
                      data: [],
                      contentType: false,
                      cache: false,
