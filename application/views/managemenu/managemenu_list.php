            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">SETTING DISPLAY MENU</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr><td></td><td><button type="submit" class="btn btn-danger btn-sm">Save Change</button></td></tr>
                        </table>
                    </form>
                    </div>
                </div>
        ...
        var t = $("#mytable").dataTable({
            ...
            columnDefs : [
                ...
                { 
                    ...
                    render : function (data, type, row) {
                        switch(data) {
                            case 'Aktif' :  return "<i class='fa fa-check'></i>"; break;
                            default  : return "<i class='fa fa-close'></i>";
                        }
                    }
                }
            ],
