        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered'>
                    ...
                    <tr><td width='200'>Is Aktif <?php echo form_error('is_aktif') ?></td><td><?php echo form_dropdown('is_aktif',array('y'=>'ACTIVE','n'=>'DEACTIVATE'),$is_aktif,array('class'=>'form-control'))?></td></tr>
                    <tr>
                        <td>
                        </td>
                        <td>
                            ...
                            <a href="<?php echo site_url('ManageMenu') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Back</a>
                        </td>
                    </tr>
                </table>
            </form>
