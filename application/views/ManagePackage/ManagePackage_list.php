  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body"> 
            ...
            <input type="text" class="form-control classUpdate input-md" id="package_id" name="package_id" value="<?php echo $id; ?>">
      ...
      <div class="modal-footer">
                ...
                var t = $("#mytable").dataTable({
                    initComplete: function() {
                        ...
                        $("#form-create_main").on('submit',(function(e) {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('ManagePackage/create_action') ?>",
                                type: "POST",
                        ...
                        $("#form-update_main").on('submit',(function(e) {
                            ...
                            $.ajax({
                                url: "<?php echo base_url('ManagePackage/update_action') ?>",
                                type: "POST",
                                data: new FormData(this),
                                contentType: false,
                                cache: false,
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?php echo base_url("ManagePackage/json") ?>', "type": "POST"},
                    columns: [
                        {
                            "data": "package_id",
                            "orderable": false
        ...
        function editModal(id){
          $.get("<?php echo base_url('ManagePackage/read') ?>/"+id, function( data ) {
          ...
          swal({
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                $.ajax({
                      url: "<?php echo base_url('ManagePackage/delete_action') ?>/"+id,
                      type: "POST",
                      data: [],
                      contentType: false,
                      cache: false,
