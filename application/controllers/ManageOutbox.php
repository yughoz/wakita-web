...
class ManageOutbox extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('ManageOutbox_model');
    ...
    public function index()
    {
        ...
        $this->template->load('template','manageoutbox/manageoutbox_list', $data);
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->ManageOutbox_model->json();
    }

    public function read($id) 
    {
        $row = $this->ManageOutbox_model->get_by_id($id);
        if ($row) {
            echo json_encode([
                "code" => "success",
    ...
    public function sendMessage($number,$message, $type = 'random') {
       ...
       try {
            ...
            $id = $this->ManageOutbox_model->insert_header($dataInsert);
            ...
            foreach ($body['data']['message'] as $key => $value) {
                ...
                $this->ManageOutbox_model->insert($data);
            }
    ...
    public function sendImgLocal($number,$message,$fileData, $type = 'random') {
       ...
       try {
            ...
            foreach ($body['data']['message'] as $key => $value) {
                ...
                $idImg = $this->ManageOutbox_model->insert($data);
