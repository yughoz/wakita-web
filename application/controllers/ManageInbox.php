...
class ManageInbox extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('ManageInbox_model');
    ...
    public function index()
    {
        ...
        $this->template->load('template','manageinbox/manageinbox_list', $data);
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->ManageInbox_model->json();
    }

    public function read($id) 
    {
        $row = $this->ManageInbox_model->get_by_id($id);
        if ($row) {
            echo json_encode([
                "code" => "success",
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->ManageInbox_model->insert($data);
            echo json_encode([
                "code" => "success",
    ...
    public function update_action() 
    {
		...
		'groupId' => $this->input->post('groupId',TRUE),
            ...
            $this->ManageInbox_model->update($this->input->post('id', TRUE), $data);
            echo json_encode([
                "code" => "success",
    ...
    public function delete_action($id) 
    {
        ...
        if ($row) {
            $this->ManageInbox_model->delete($id);
            echo json_encode([
                "code" => "success",
