...
function select2_dinamis($name,$table,$field,$pk,$class = "",$placeholder=""){
    $ci = get_instance();
    $select2 = '<select id="'.$name.'" name="'.$name.'" class="form-control select2 js-example-basic-single '.$class.'" 
