...
foreach ($non_pk as $row) {
    if (in_array($row['column_name'], array('created','updated'))) {
        $string .= "\n\t\t'" . $row['column_name'] . "' => date(\"Y-m-d H:i:s\"),";
    } elseif (in_array($row['column_name'], array('createdby','updatedby'))) {
        $string .= "\n\t\t'" . $row['column_name'] . "' => \$this->session->userdata('email'),";
    } else {
...
$string .= "\n\t    );
    ...
    public function update_action() 
    {
        ...
        if (\$this->form_validation->run() == FALSE) {
            ...
            \$data = array(";
foreach ($non_pk as $row) {
    if (in_array($row['column_name'], array('updated'))) {
        $string .= "\n\t\t'" . $row['column_name'] . "' => date(\"Y-m-d H:i:s\"),";
    } elseif (in_array($row['column_name'], array('updatedby'))) {
        $string .= "\n\t\t'" . $row['column_name'] . "' => \$this->session->userdata('email'),";
    } else {
        $string .= "\n\t\t'" . $row['column_name'] . "' => \$this->input->post('" . $row['column_name'] . "',TRUE),";
    }
