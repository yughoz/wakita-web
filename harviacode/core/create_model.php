...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', '<a href=\"#\" class=\"btn btn-danger btn-sm\" onclick=\"editModal(\$1);return false;\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i> </a>'. ' <a href=\"#\" class=\"btn btn-danger btn-sm\" onclick=\"delete_conf(\$1);return false;\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>', '$pk');
